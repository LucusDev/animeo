...
import '../models/browse_network_page.dart';

class HomeNetworkRepo {
  ///get Recent Episodes
  Future<Result<List<Anime>>> get(BrowseNetworkPage browseNetworkPage) async {
    String modifiedUrl = '';
    int pageNumber = 0;
    ...
    browseNetworkPage.when(
      ...
      seasonal: (pageNum, season, year) {
        ...
        if (!(season == null || year == null)) {
          modifiedUrl =
              '${Urls.main}/sub-category/${season.toValue()}-$year-anime?page=$pageNum';
        } else {
